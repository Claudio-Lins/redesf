...
export default function Post() {
  return (
    <div>
      ...
      <section className="bg-purple-800 p-6 md:py-20">
      ...
      <section className="bg-gray-50 rounded-lg shadow-lg md:w-2/5 md:-mt-10 mx-auto">
        <div className="text-center px-4">
          <div className="rounded-lg p-2">
            <Image
              className="rounded-md shadow-lg text-center"
          ...
          <div className='text-sm font-light text-gray-700 p-4'>
            <p>
