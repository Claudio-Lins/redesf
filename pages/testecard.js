...
import dadosConselhoInternacional from '../data/dadosConselhoInternacional';
import ConselhoInternacionalCard from "../components/ConselhoInternacionalCard";
    ...
    <div>
      ...
      <div className="max-w-md sm:max-w-xl lg:max-w-6xl mx-auto px-8 lg:px-12 py-8">
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-2 xl:grid-cols-3">
          {dadosConselhoInternacional.map((conselhoInternacional) => (
            <ConselhoInternacionalCard destination={conselhoInternacional} key={conselhoInternacional.nome} />
          ))}
        </div>
      </div>
    </div>
